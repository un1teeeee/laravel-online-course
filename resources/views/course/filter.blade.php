        ...
        <section class="catalog__container container">
            <div class="catalog__menu">
                ...
                <nav class="catalog__nav">
                    <a href="{{ route('catalog.filter', 'PHP') }}" class="catalog__nav-item {{ $progLanguage == 'PHP' ? 'catalog__nav-item--active' : '' }}">
                        <img src="/images/main/catalog/php-logo.svg" class="catalog__nav-item--image" alt="">
                        <span>PHP</span>
                    </a>
                    <a href="{{ route('catalog.filter', 'Laravel') }}" class="catalog__nav-item {{ $progLanguage == 'Laravel' ? 'catalog__nav-item--active' : '' }}">
